    ...
    <div className={`relative min-h-screen font-sans selection:bg-amber-500/30 selection:text-amber-900 overflow-x-hidden transition-colors duration-1000 ease-in-out
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 px-6 py-5 flex justify-between items-center mix-blend-difference text-white transition-all duration-500
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-black tracking-widest uppercase">Solar<span className="text-amber-400">DAO</span></span>
        </div>
        
        <div className="hidden md:flex items-center gap-8">
            <span className="text-xs font-bold tracking-widest uppercase opacity-80 hover:text-amber-400 cursor-pointer">Market</span>
            <span className="text-xs font-bold tracking-widest uppercase opacity-80 hover:text-amber-400 cursor-pointer">Validators</span>
            <span className="text-xs font-bold tracking-widest uppercase opacity-80 hover:text-amber-400 cursor-pointer">Governance</span>
            <button className="border border-white/30 px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-all">
                Connect Wallet
            </button>
        </div>
